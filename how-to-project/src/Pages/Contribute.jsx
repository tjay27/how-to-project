          ...
          <div class="publishPost">
            <Box sx={{
              ...
              <TextField
                ...
                onChange={(e) => {
                  setMultiformValue({ ...multiformValue, Title: (e.target.value) })
                }}
                required />
              ...
              <TextField
                ...
                onChange={(e) => {
                  setMultiformValue({ ...multiformValue, Topic: (e.target.value) })
                }}
                sx={{ margin: 2 }}
                required />
              ...
              <TextField
                ...
                onChange={(e) => {
                  setMultiformValue({ ...multiformValue, description: (e.target.value) })
                }}
                sx={{ margin: 2 }}
                required />
              ...
              <TextField
                ...
                onChange={(e) => {
                  setMultiformValue({ ...multiformValue, link: e.target.value })
                }}
                sx={{ margin: 2 }}
              />
              ...
              <FormControl sx={{ margin: 2 }}>
                ...
                >
                  <FormControlLabel control={<Radio />} label="Research Paper" value="ResearchPaper"
                    onChange={(e) => {
                      setMultiformValue({ ...multiformValue, category: ("Research Paper") })
                    }} />
                  <FormControlLabel control={<Radio />} label="Blogs" value="Blogs"
                    onChange={(e) => {
                      setMultiformValue({ ...multiformValue, category: ("Blogs") })
                    }} />
                  <FormControlLabel control={<Radio />} label="Technical Stuff" value="TechnicalStuff"
                    onChange={(e) => {
                      setMultiformValue({ ...multiformValue, category: ("Technical Stuff") })
                    }} />
